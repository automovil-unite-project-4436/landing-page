...
@Component({
  selector: 'app-root',
  imports: [TranslateModule, HomePageComponent, NavbarComponent, FunctionalitiesPageComponent, BenefitsPageComponent, PopularCarsPageComponent, FooterComponent, DownloadPageComponent, TestimonialsPageComponent],
